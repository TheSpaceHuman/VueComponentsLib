  ...
  export default {
    ...
    methods: {
      ...
      CountNarStenPanel(costPanel) {
        ...
        let countPanelLength = Math.ceil(((this.NarStenPanelLength - 0.156) / 1.2) * 2)
        let countPanelWidth = Math.ceil(((this.NarStenPanelWidth - 0.156) / 1.2) * 2)
      ...
      CountBrus(obj, price) {
        ...
        //Количество, шт (по 6м)
        const CountNapPanelCol1 = Math.ceil(NapPanel.allPan * 10.5 / 6 * 1.1)
        const CountNarPanelCol1 = Math.ceil(NarPanel.allPan * 6.6 / 6 * 1.2)
      ...
      CountConsumables(obj, price) {
        ...
        //Шуруп 7,5*112
        let shurupInt = parseInt(this.NarStenPanelLength * 2) + parseInt(this.NarStenPanelWidth * 2) + parseInt(this.MegkomPeregLength)
