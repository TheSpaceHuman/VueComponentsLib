  ...
  export default {
    ...
    methods: {
      ...
      CountNarStenPanel(costPanel) {
        ...
        let countPanelLength = Math.ceil((this.NarStenPanelLength - 0.156) / 0.6 * 2) * 3
        let countPanelWidth = Math.ceil((this.NarStenPanelWidth - 0.156) / 0.6 * 2) * 3
      ...
      CountConsumables(obj, price) {
        ...
        const mezhetPok = this.NarStenPanelLength * this.NarStenPanelWidth * 2
