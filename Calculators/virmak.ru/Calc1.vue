...
<script>
  ...
  export default {
    ...
    data() {
      return {
        lorem: {
          name: 'Изовер Друхэтажный (пол изовер)',
    ...
    methods: {
      ...
      CountNarStenPanel(costPanel) {
        ...
        let countPanelLength = Math.ceil((this.NarStenPanelLength - 0.156) / 0.6 * 2) * 2
        let countPanelWidth = Math.ceil((this.NarStenPanelWidth - 0.156) / 0.6 * 2) * 2
